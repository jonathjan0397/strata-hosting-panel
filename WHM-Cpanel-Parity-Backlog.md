...
- migration reset-required cutover for mailboxes, FTP accounts, Web Disk accounts, databases, and database grants, preserving metadata without transferring plaintext passwords and blocking source cleanup until fresh credentials are set
...
- CSV export for historical traffic reports by date and domain
...
- Web Disk-style desktop file access through dedicated WebDAV-over-HTTPS accounts on port 2078
