...
configure_postfix_dkim_final_signer() {
...
def main() -> int:
    ...
    signature = dkim.sign(
        ...
        include_headers=extract_header_names(message),
...
case "$DEBIAN_VERSION" in
    13) PHP_CODENAME="trixie"; PHP_VERSIONS=(7.4 8.0 8.2 8.3 8.4) ;;
...
DEBIAN_FRONTEND=noninteractive apt-get install -y pure-ftpd pure-ftpd-common \
    ...
    opendkim opendkim-tools python3-dkim
