...
[![Release](https://img.shields.io/badge/Release-1.0.0--BETA--3.16-indigo?style=flat-square)](https://github.com/jonathjan0397/strata-hosting-panel/releases/tag/1.0.0-BETA-3.16)
...
**License:** MIT | **Target OS:** Debian 11 / 12 / 13 | **Status:** 1.0.0-BETA-3.16 public testing

---

> **Pre-release Beta Software**
>
> 1.0.0-BETA-3.16 is available for public testing and should not be treated as production-ready.
...
/usr/sbin/strata-upgrade --version 1.0.0-BETA-3.16
```
...
```bash
/usr/sbin/strata-upgrade --file /root/strata-hosting-panel-1.0.0-BETA-3.16.tar.gz
```
