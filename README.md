...
[![Release](https://img.shields.io/badge/Release-1.0.0--BETA--3.28-indigo?style=flat-square)](https://github.com/jonathjan0397/strata-hosting-panel/releases/tag/1.0.0-BETA-3.28)
...
**License:** MIT | **Target OS:** Debian 11 / 12 / 13 | **Status:** 1.0.0-BETA-3.28 public testing

---

> **Pre-release Beta Software**
>
> 1.0.0-BETA-3.28 is available for public testing and should not be treated as production-ready.
...
```bash
/usr/sbin/strata-upgrade --file /root/strata-hosting-panel-1.0.0-BETA-3.28.tar.gz
```
