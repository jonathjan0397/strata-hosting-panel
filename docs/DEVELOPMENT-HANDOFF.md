...
- latest published release at the time of this handoff: `1.0.3`
- `main` and tag `1.0.3` should be treated as the current stable release baseline
...
- `main` = frozen release branch at `1.0.3` except for release blockers
