    ...
    <div class="min-h-screen bg-gray-950 text-gray-100">
        ...
        >
            ...
            <div class="flex h-16 items-center gap-3 px-5 border-b border-gray-800">
                ...
                <span class="text-lg font-semibold tracking-tight">{{ $page.props.branding?.name || 'Strata Panel' }}</span>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <template v-else-if="$page.props.auth.user.roles?.includes('user')">
                    <NavGroup label="My Hosting">
                        ...
                        <NavItem :href="route('user.apps.catalog')" :active="$page.url.startsWith('/my/apps')">
                            <template #icon>
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
