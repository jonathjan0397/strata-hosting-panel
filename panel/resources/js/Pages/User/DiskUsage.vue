    ...
    <AppLayout title="Disk Usage">
        <div class="space-y-6 p-6">
            <PageHeader
                eyebrow="Files"
                title="Disk Usage"
                :description="`Inspect which directories are using storage inside /var/www/${account.username}.`"
            >
                <template #actions>
                    <Link :href="route('my.files.index')" class="text-sm font-medium text-indigo-400 transition-colors hover:text-indigo-300">
                        Open File Manager
                    </Link>
                </template>
            </PageHeader>
