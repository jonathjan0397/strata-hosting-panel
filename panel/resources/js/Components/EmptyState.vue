<template>
    <div class="rounded-2xl border border-dashed border-gray-800 bg-gray-900/60 px-6 py-10 text-center">
        <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-gray-800 text-gray-400">
            <slot name="icon">
        ...
        <h3 class="mt-4 text-sm font-semibold text-gray-200">{{ title }}</h3>
        <p v-if="description" class="mx-auto mt-2 max-w-md text-sm text-gray-500">{{ description }}</p>
