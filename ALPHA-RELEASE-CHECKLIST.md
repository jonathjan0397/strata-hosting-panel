...
- [ ] Reset/uninstall script can remove the installation from the validation host.
...
- [ ] DNS zone/record provisioning works.
- [ ] Mailbox creation and Sieve sync work.
...
- [ ] Migration prepare, transfer, restore, and conservative cutover blockers are visible.
